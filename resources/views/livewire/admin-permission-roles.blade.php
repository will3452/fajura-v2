<div class="box" x-data="{
    ...
    <div class="is-flex is-justify-content-space-between is-justify-content-space-between">
        <h3 class="title is-6">{{ strtoupper($role->name) }}</h3>
        <div>
            <button class="button is-small is-rounded is-dark" x-on:click="editable = true" x-show="!editable">Edit Permissions</button>
            <button class="button is-small is-rounded is-info" x-on:click="editable = false" x-show="editable">End Edit</button>
        </div>
    </div>
